...
typedef struct {
    PyObject_HEAD
    ns3::TracedValue< ns3::States_t > *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3TracedValue__Ns3States_t;


extern PyTypeObject PyNs3TracedValue__Ns3States_t_Type;

extern std::map<void*, PyObject*> PyNs3TracedValue__Ns3States_t_wrapper_registry;
...
public:
    ...
    static PyObject * _wrap_Notify_sender(PyNs3TcpSocketBase *self, PyObject *args, PyObject *kwargs);
    inline void Notify_sender__parent_caller(ns3::Ptr< ns3::Packet > packet, ns3::TcpHeader const & tcpHeader, ns3::Address const & fromAddress, ns3::Address const & toAddress)
    { ns3::TcpSocketBase::Notify_sender(packet, tcpHeader, fromAddress, toAddress); }
